...
⏱️ **10 minut** · Poziom: Początkujący · Potrzebne: chatgpt.com + dowolny PDF/obraz

🌐 [English](../../en/lessons/04-files-and-images.md) · [← Wstecz](03-podstawy-promptow.md) · [Strona kursu](../README.md) · [Dalej: Instalacja aplikacji ChatGPT →](05-instalacja-chatgpt-desktop.md)

---

## 🧠 Teoria (3 min)

ChatGPT nie ogranicza się do tekstu, który wpisujesz. Możesz **wysyłać pliki**, a on je przeczyta:

- **PDF-y, dokumenty Word, arkusze, pliki tekstowe** → ChatGPT czyta treść.
- **Obrazy i zrzuty ekranu** → ChatGPT je *widzi* (wykresy, zdjęcia, pismo odręczne, komunikaty błędów).

Dla początkujących to ogromne: wskaż ChatGPT prawdziwy dokument i powiedz „wyjaśnij to” zamiast przepisywać.
...
1. Znajdź dowolny PDF (instrukcję, raport, paragon). Nie masz? W Edge otwórz stronę → **menu ⋯ → Drukuj → Zapisz jako PDF**.
2. W chatgpt.com kliknij ikonę **➕ / spinacz** obok pola wiadomości.
3. Wybierz swój PDF.
4. Wyślij:
...
### Krok 3 — Pozwól ChatGPT odczytać zrzut ekranu

1. Naciśnij **Windows + Shift + S**, aby wyciąć fragment ekranu (to go kopiuje).
2. Wklej do pola wiadomości ChatGPT przez **Ctrl + V**.
3. Wypróbuj:
...
| Typ pliku | ChatGPT potrafi… |
|-----------|-------------|
| PDF / Word / TXT | Streszczać, odpowiadać, wyciągać informacje |
...
- [ ] Wkleiłeś zrzut ekranu (**Win+Shift+S**, potem **Ctrl+V**) i ChatGPT go opisał.
...
Znajdź prawdziwy dokument, którego unikałeś (regulamin, formularz, gęsty wątek e-maili). Wyślij go i poproś ChatGPT, aby *„wyjaśnił, co to dla mnie znaczy i co muszę zrobić”*.

---

## 💡 Najważniejsze wnioski

- 📎 Wysyłaj PDF-y/dokumenty/obrazy; ChatGPT je czyta i widzi.
- **Win+Shift+S**, potem **Ctrl+V** wkleja zrzuty ekranu prosto do ChatGPT.
