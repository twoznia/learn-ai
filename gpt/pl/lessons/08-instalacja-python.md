...
🌐 [English](../../en/lessons/08-install-python.md) · [← Wstecz](07-wlasne-gpt-i-projekty.md) · [Strona kursu](../README.md) · [Dalej: Klucz API →](09-klucz-api.md)

---

## 🧠 Teoria (2 min)

**Python** to język programowania, który czyta się prawie jak angielski. To język nr 1 dla AI, a OpenAI udostępnia oficjalną bibliotekę (`openai`), która ułatwia rozmowę z GPT. Nie musisz „zostać programistą” — będziesz kopiować małe skrypty i je uruchamiać.
...
- [ ] Utworzyłeś folder `learn-ai-gpt`.

---

## 🎯 Zadanie

Jeśli coś zwróciło błąd, zastosuj sztuczkę z Lekcji 4: wytnij błąd (**Win+Shift+S**), wklej do ChatGPT i zapytaj *„Jak naprawić ten błąd instalacji Pythona na Windows? Jestem początkujący.”*
