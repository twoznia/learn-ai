...
🌐 [English](../../en/track-a/02-prompt-library.md) · [← Wstecz](01-mistrzostwo-custom-gpt.md) · [Indeks ścieżki](../README.md) · [Dalej: Canvas i analiza danych →](03-canvas-i-analiza-danych.md)
...
1. **Szablony z lukami** — wyraźnie oznaczone puste miejsca (`<tak_o>`).
...
Zachowaj kopię przed ulepszeniem szablonu:
...
> 💡 **Bonus:** wyślij ten folder do Własnego GPT jako **Knowledge**. Wtedy zapytaj *„który z moich zapisanych promptów pasuje do tego zadania?”*, a on wybierze z Twojej biblioteki.
...
- Wyślij bibliotekę do Własnego GPT, aby wybierał właściwy prompt.
