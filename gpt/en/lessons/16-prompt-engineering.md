...
⏱️ **10 minutes** · Level: Beginner → Intermediate · Needs: any ChatGPT (web/app/code)

🌐 [Polski](../../pl/lessons/16-prompt-engineering.md) · [← Prev](15-web-search.md) · [Course home](../README.md) · [Next: Costs & safety →](17-costs-safety.md)

---

## 🧠 Theory (4 min)

You learned the basics (R-C-T-F) in Lesson 3. Here are the **patterns professionals use** for consistently great results. None require code — they work anywhere you chat with ChatGPT.
...
### 2. Ask ChatGPT to think before answering
...
Try each on your own content in ChatGPT:

### Drill 1 — Few-shot
Give ChatGPT 2 examples of the tone you use in work emails, then ask for a new one in that same tone.
...
| Trusting facts blindly | Ask it to flag uncertainty; verify (or use web search, Lesson 15) |
...
- [ ] You got ChatGPT to return strict JSON.
- [ ] You let ChatGPT ask *you* clarifying questions.
...
- Let ChatGPT ask questions; treat first answers as drafts and iterate.
- For facts, combine good prompts with **web search** (Lesson 15).
