...
⏱️ **10 minutes** · Level: Beginner · Needs: your chatgpt.com account
...
A **prompt** is your instructions to ChatGPT. The difference between a mediocre answer and a great one is almost always the prompt.

### The 4 ingredients of a great prompt (**R-C-T-F**)

| Ingredient | Question it answers | Example |
|-----------|---------------------|---------|
| **R — Role** | Who should ChatGPT act as? | "You are a friendly IT helpdesk agent." |
...
A good answer here is ChatGPT admitting it can't know that.
...
- Give ChatGPT permission to say "I'm not sure" to reduce hallucinations.
