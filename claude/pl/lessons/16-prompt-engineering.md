...
⏱️ **10 minut** · Poziom: Początkujący → Średni · Potrzebne: dowolny Claude (sieć/desktop/code)

🌐 [English](../../en/lessons/16-prompt-engineering.md) · [← Wstecz](15-mcp.md) · [Strona kursu](../README.md) · [Dalej: Koszty i bezpieczeństwo →](17-koszty-bezpieczenstwo.md)

---

## 🧠 Teoria (4 min)

Podstawy (R-K-Z-F) poznałeś w Lekcji 3. Oto **wzorce używane przez profesjonalistów**, które dają stale świetne wyniki. Żaden nie wymaga kodu — działają wszędzie, gdzie rozmawiasz z Claude.

### 1. Podaj przykłady (few-shot)

Pokaż wzorzec, którego chcesz, potem poproś o więcej takich.
...
### 2. Poproś Claude, aby pomyślał przed odpowiedzią
...
To widocznie poprawia zadania z matematyki, logiki i planowania.
...
Wypróbuj każdą na własnych treściach w claude.ai lub Claude Desktop:

### Ćwiczenie 1 — Few-shot
Daj Claude 2 przykłady tonu, którego używasz w e-mailach służbowych, potem poproś o nowy w tym samym tonie.
...
| Ślepe zaufanie faktom | Poproś o oznaczanie niepewności; weryfikuj ważne rzeczy |
...
- [ ] Uzyskałeś od Claude ścisły JSON.
- [ ] Pozwoliłeś Claude zadać *Tobie* pytania doprecyzowujące.
...
- Pozwól Claude pytać; traktuj pierwsze odpowiedzi jak szkice i iteruj.
- Zawsze zostawiaj miejsce na „Nie jestem pewny”, aby ograniczyć zmyślone fakty.
