...
⏱️ **10 minutes** · Level: Beginner → Intermediate · Needs: any Claude (web/desktop/code)

[← Prev](15-mcp-intro.md) · [Course home](../README.md) · [Next: Costs & safety →](17-costs-safety.md)

---

## 🧠 Theory (4 min)

You learned the basics (R-C-T-F) in Lesson 3. Here are the **patterns professionals use** to get consistently great results. None require code — they work anywhere you chat with Claude.

### 1. Give examples (few-shot)

Show the pattern you want, then ask for more of it.
...
### 2. Ask Claude to think before answering
...
This visibly improves math, logic, and planning tasks.
...
Try each on your own content in claude.ai or Claude Desktop:

### Drill 1 — Few-shot
Give Claude 2 examples of the tone you use in work emails, then ask it to write a new one in that same tone.
...
| Trusting facts blindly | Ask it to flag uncertainty; verify important things |
...
- [ ] You got Claude to return strict JSON.
- [ ] You let Claude ask *you* clarifying questions.

---

## 🎯 Homework

Rewrite the "annoying task" prompt from Lesson 1 using the **power prompt template**. Save the final version — it's a tool you'll reuse for months.
...
- Let Claude ask questions; treat first answers as drafts and iterate.
- Always leave room for "I'm not sure" to reduce made-up facts.
