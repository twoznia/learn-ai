# Lesson 06 — Everyday Tasks with Gemini

⏱️ **10 minutes** · Level: Beginner · Needs: gemini.google.com

🌐 [Polski](../../pl/lessons/06-codzienne-zadania.md) · [← Prev](05-gemini-in-chrome-and-google.md) · [Course home](../README.md) · [Next: Gems →](07-gems-custom-assistants.md)

---

## 🧠 Theory (2 min)

The goal now is to build the **habit** of reaching for Gemini. The trick is having a few **ready-made workflows** so you never start from a blank page. Below are copy-paste recipes for common jobs. Fill in the `<brackets>` and go.

---

## 🛠️ Practice — 5 real workflows (7 min)

Open gemini.google.com and try at least three with your own real content.

### 1. 📧 Reply to an email

```text
You are my communication assistant. Below is an email I received.
Write a reply that is polite, clear, and to the point in under 5 sentences.
...
Talking *back* to Gemini is where beginners level up fastest.
...
- [ ] You refined at least one answer with a follow-up.
- [ ] Gemini feels like a tool you'd actually reach for.

---

## 🎯 Homework

Pick the workflow you'll use most and paste it into `my-prompts.txt`. Tomorrow, use it on a real task **before** you'd normally do it by hand. Time how long it saves.
...
- Building the *habit* of opening Gemini is the whole game.
