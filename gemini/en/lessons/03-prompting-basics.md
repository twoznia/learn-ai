...
🌐 [Polski](../../pl/lessons/03-podstawy-promptow.md) · [← Prev](02-first-chat.md) · [Course home](../README.md) · [Next: Files and images →](04-files-and-images.md)

---

## 🧠 Theory (4 min)

A **prompt** is your instructions to Gemini. The difference between a mediocre answer and a great one is almost always the prompt.

### The 4 ingredients of a great prompt (**R-C-T-F**)

| Ingredient | Question it answers | Example |
|-----------|---------------------|---------|
| **R — Role** | Who should Gemini act as? | "You are a friendly IT helpdesk agent." |
| **C — Context** | What's the situation? | "My mom, 70, can't open her email." |
...
Adding **Format** alone dramatically improves results.
...
open her email. Write clear step-by-step instructions to open Gmail in Chrome.
...
A good answer here is Gemini admitting it can't know that.
...
**4. The Brainstormer**
```text
Give me 10 ideas for <goal>. Make them varied: some safe, some bold. One line each.
```
...
- [ ] You saved 5 patterns somewhere reusable.

---

## 🎯 Homework

Take your "annoying task" and write **one strong prompt** using all four R-C-T-F ingredients. Save it in a text file called `my-prompts.txt`.
...
- Give Gemini permission to say "I'm not sure" to reduce hallucinations.
