...
🌐 [Polski](../../pl/lessons/08-instalacja-python.md) · [← Prev](07-gems-custom-assistants.md) · [Course home](../README.md) · [Next: Get your API key →](09-get-api-key.md)

---

## 🧠 Theory (2 min)

**Python** is a programming language that reads almost like English. It's the #1 language for AI, and Google provides an official Python library (`google-genai`) that makes talking to Gemini easy. You won't need to "become a programmer" — you'll copy small scripts and run them.
...
- [ ] You created a `learn-ai-gemini` folder.

---

## 🎯 Homework

If anything threw an error, use the Lesson-4 trick: snip the error (**Win+Shift+S**), paste it into Gemini, and ask *"How do I fix this Python install error on Windows? I'm a beginner."*
