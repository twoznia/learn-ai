...
⏱️ **10 minut** · Poziom: Początkujący → Średni · Potrzebne: dowolny Gemini (sieć/kod)

🌐 [English](../../en/lessons/16-prompt-engineering.md) · [← Wstecz](15-grounding-google-search.md) · [Strona kursu](../README.md) · [Dalej: Koszty i bezpieczeństwo →](17-koszty-bezpieczenstwo.md)

---

## 🧠 Teoria (4 min)

Podstawy (R-K-Z-F) poznałeś w Lekcji 3. Oto **wzorce używane przez profesjonalistów**, które dają stale świetne wyniki. Żaden nie wymaga kodu — działają wszędzie, gdzie rozmawiasz z Gemini.
...
### 2. Poproś Gemini, aby pomyślał przed odpowiedzią
...
Wypróbuj każdą na własnych treściach w gemini.google.com:

### Ćwiczenie 1 — Few-shot
Daj Gemini 2 przykłady tonu, którego używasz w e-mailach służbowych, potem poproś o nowy w tym samym tonie.
...
| Ślepe zaufanie faktom | Poproś o oznaczanie niepewności; weryfikuj (lub użyj ugruntowania, Lekcja 15) |
...
- [ ] Uzyskałeś od Gemini ścisły JSON.
- [ ] Pozwoliłeś Gemini zadać *Tobie* pytania doprecyzowujące.
...
- Pozwól Gemini pytać; traktuj pierwsze odpowiedzi jak szkice i iteruj.
- Dla faktów łącz dobre prompty z **ugruntowaniem** (Lekcja 15).
