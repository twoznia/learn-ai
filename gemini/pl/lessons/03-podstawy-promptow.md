...
**Prompt** to Twoja instrukcja dla Gemini. Różnica między przeciętną a świetną odpowiedzią prawie zawsze wynika z promptu.

### 4 składniki świetnego promptu (**R-K-Z-F**)

| Składnik | Na jakie pytanie odpowiada | Przykład |
|-----------|---------------------|---------|
| **R — Rola** | Kim ma być Gemini? | „Jesteś przyjaznym pracownikiem helpdesku IT.” |
...
może otworzyć e-maila. Napisz jasne instrukcje krok po kroku, jak otworzyć Gmaila w Chrome.
...
Dobra odpowiedź to przyznanie się przez Gemini, że nie może tego wiedzieć.
...
- Daj Gemini prawo powiedzieć „Nie jestem pewny”, aby ograniczyć halucynacje.
